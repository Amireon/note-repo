...
![](https://ypic.oss-cn-hangzhou.aliyuncs.com/202211181756124.png)
...
- 集中在CPU内![](https://ypic.oss-cn-hangzhou.aliyuncs.com/202211181804316.png)
**（2）软件实现（程序查询）**
![](https://ypic.oss-cn-hangzhou.aliyuncs.com/202211181809163.png)


### 2.中断服务程序入口地址的寻找
**1.硬件向量法**
利用硬件产生向量地址，中断程序入口地址称为中断向量。
![](https://ypic.oss-cn-hangzhou.aliyuncs.com/202211181815622.png)

**2.软件查询法**
![](https://ypic.oss-cn-hangzhou.aliyuncs.com/202211181816009.png)
...
![](https://ypic.oss-cn-hangzhou.aliyuncs.com/202211181958491.png)

**2.实现多重中断的条件**
1. 提前设置开中断指令
2. 优先级别高的中断源有权中断优先级别低的中断源
 ![](https://ypic.oss-cn-hangzhou.aliyuncs.com/202211182004753.png)

3. 屏蔽技术
（1）屏蔽触发器的作用
![](https://ypic.oss-cn-hangzhou.aliyuncs.com/202211182010949.png)
